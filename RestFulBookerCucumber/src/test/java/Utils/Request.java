...
public class Request {
    ...
    {
        RestAssured.baseURI = BookingEndPoints.URL;
    ...
    public static Response put(String endpoint, String id, String payload)
    {
        ...
        Response response = RestAssured
                ...
                .body(payload).and().pathParam("id", id).when().put(endpoint);
        response.then().log().body();
        return  response;
    }
    ...
    {
        RestAssured.baseURI = BookingEndPoints.URL;
        Response response = RestAssured.given().pathParam("id", id).when().delete(endpoint);
        response.then().log().body();
        return response;
    }
